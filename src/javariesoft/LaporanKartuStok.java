...
public class LaporanKartuStok extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtBarang.setBounds(180, 20, 180, 21);
        ...
        jScrollPane2.setBounds(20, 52, 450, 200);
        ...
        btnExit.setBounds(120, 260, 80, 23);

        java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
        setBounds((screenSize.width-502)/2, (screenSize.height-323)/2, 502, 323);
...
private void txtBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBarangActionPerformed
        try {
            // TODO add your handling code here:
                ...
                String sql="select KODEBARANG,NAMABARANG,(select jenis from jenisbarang where JENISBARANG.ID=BARANG.IDJENIS) as MERK FROM BARANG where KODEBARANG like '"+txtBarang.getText()+"%' or lower(namabarang) like '%"+txtBarang.getText().toLowerCase()+"%'";
                j.executeQuery(sql);
