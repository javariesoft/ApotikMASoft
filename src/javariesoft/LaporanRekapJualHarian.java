...
/*
 * LaporanRekapJualHarian.java
 *
 * Created on Jan 12, 2012, 8:38:24 AM
 */
package javariesoft;
 ...
 * @author erwadi
 */
public class LaporanRekapJualHarian extends javax.swing.JInternalFrame {
    java.text.DateFormat d = new SimpleDateFormat("yyyy-MM-dd");
    /** Creates new form LaporanRekapJualHarian */
    public LaporanRekapJualHarian() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(LaporanRekapJualHarian.class);
        ...
        btnKeluar.setBounds(140, 50, 120, 40);

        setBounds(0, 0, 296, 137);
...
// TODO add your handling code here:
        ...
        parameter.put("Ptanggal", tgl1.getText());
        try { 
