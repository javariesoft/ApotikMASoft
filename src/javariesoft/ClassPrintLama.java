    ...
    public void cetakfaktur(String nfak){
        ...
        try {
            ...
            try {
                ...
                p.append(data2);
                p.append(data3);                                                                         //                  //       //              //
                p.append("APOTEK                                                                         Kepada : "+ cp.cetak(pel, 45, 0) +"\r\n");
                //p.append("No Izin PBF : HK.07.01/V/302/14                                                             "+ cp.cetak(Altpel, 50, 0) +"\r\n");
              if(rs1.getString(18).length()>=45){
                p.append("CV.MIRANTI ADILHA                                                                        "+ cp.cetak(Altpel, 50, 0) +"\r\n"); 
                p.append("Jl. Gajah Mada No. 03 Gunung Pangilun-Padang                                             "+ cp.cetak(Altpel1, 50, 0) +"\r\n"); 
                p.append("Telp/Fax  : 0751-447602                                                                           No Faktur   : "+cp.cetak(rs1.getString(2), 10, 1)+"\r\n");
                p.append("NPWP : 02.045.601.8-201.000                                                                       Tanggal     : "+cp.cetak(rs1.getString(3), 10, 1) +"\r\n");
                p.append("                                                                                                  Jatuh Tempo : "+cp.cetak(rs1.getString(6), 10, 1) +" \r\n"); 
              }else{
                p.append("CV.MIRANTI ADILHA                                                                        "+ cp.cetak(Altpel, 50, 0) +"\r\n"); 
                p.append("Jl. Gajah Mada No. 03 Gunung Pangilun-Padang                                                      No Faktur   : "+cp.cetak(rs1.getString(2), 10, 1)+"\r\n");
                p.append("Telp/Fax  : 0751-447602                                                                           Tanggal     : "+cp.cetak(rs1.getString(3), 10, 1) +"\r\n");
                p.append("NPWP : 02.045.601.8-201.000                                                                       Jatuh Tempo : "+cp.cetak(rs1.getString(6), 10, 1) +" \r\n");
