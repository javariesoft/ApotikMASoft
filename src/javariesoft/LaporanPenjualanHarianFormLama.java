...
/*
 * LaporanPenjualanHarianFormLama.java
 *
 ...
 * @author erwadi
 */
public class LaporanPenjualanHarianFormLama extends javax.swing.JInternalFrame {
     ...
     */
    public LaporanPenjualanHarianFormLama() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(LaporanPenjualanHarianFormLama.class);
        ...
        btnKeluar.setBounds(160, 110, 120, 40);
        ...
        cbPembayaran.setBounds(110, 70, 150, 20);

        setBounds(0, 0, 311, 197);
