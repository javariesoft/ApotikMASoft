...
////            dbsup = new supplierDao(c);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setBounds(10, 10, 910, 700);

        getContentPane().add(panelCool1, java.awt.BorderLayout.CENTER);

        setSize(new java.awt.Dimension(951, 773));
                        ...
                        if (cekperiodeAda(c, per)) {
                            if (cekperiode(c, per)) {
                                String sql = "INSERT INTO HUTANGBAYAR "
                                        ...
                                        //+ "        '" + (KodeTransaksiKhusus.getText().substring(0, 8) + "" + hutangidKhusus) + "',\n"
...
//        IDJurnal = jurnalDao.getIDJurnal(c);
//        txtNoRef1.setText("F" + com.erv.function.Util.getbln(tgl) + com.erv.function.Util.getthn(tgl) + IDJurnal);
//        KodeTransaksiKhusus.setText(hutangbayarDao.getKodeHutangBayar(c));
    ...
    void insertJurnal(Connection c) throws SQLException {
        ...
        if (jTabbedPane1.getSelectedIndex() == 0) {
            String tgl = com.erv.function.Util.toDateStringSql(new Date());
            String kdjrn = "";
            kdjrn = "JH" + com.erv.function.Util.getbln(tgl) + com.erv.function.Util.getthn(tgl) + IDJurnal;
            IDJurnal = jurnalDao.getIDJurnal(c);
            j.setID(IDJurnal);
