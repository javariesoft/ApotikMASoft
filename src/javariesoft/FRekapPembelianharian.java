...
java.text.DateFormat d = new SimpleDateFormat("yyyy-MM-dd");
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(140, 40, 320, 120);
        ...
        btnKeluar.setBounds(230, 120, 130, 25);
        ...
        btnPreview.setBounds(70, 120, 130, 25);
...
void reloadData() {
        try {
            ...
            j.executeQuery("Select IDSUPPLIER , NAMA  from SUPPLIER where IDSUPPLIER like '"+ txtnamasupplier.getText() +"%' or lower(NAMA) like '%" + txtnamasupplier.getText().toLowerCase() + "%'");
