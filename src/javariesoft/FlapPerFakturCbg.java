 ...
 * @author eigher
 */
public class FlapPerFakturCbg extends javax.swing.JInternalFrame {
    Connection c;
    /** Creates new form FlapPerFaktur */
    public FlapPerFakturCbg() {
        initComponents();
        try {
            c=koneksi.getKoneksiJ();
        } catch (SQLException ex) {
            Logger.getLogger(FlapPerFakturCbg.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FlapPerFakturCbg.class);
