 ...
 * @author erwadi
 */
public class LapReturBeliFaktur extends javax.swing.JInternalFrame {
com.erv.function.Util u = new com.erv.function.Util();
Connection c;
    /** Creates new form LaporanKartuStok */
    public LapReturBeliFaktur() {
        initComponents();
        try {
            c = koneksi.getKoneksiJ();
            txtTahun.setText(u.thnsekarang+"");
        } catch (SQLException ex) {
            Logger.getLogger(LapReturBeliFaktur.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(LapReturBeliFaktur.class);
        ...
        jScrollPane2.setBounds(10, 70, 600, 230);
        ...
        btnExit.setBounds(170, 310, 150, 40);
...
// TODO add your handling code here:
    ...
    void reloadData() {
        try {
            ...
            String sql = "SELECT RETURBELI.KODERETURBELI,RETURBELI.TANGGAL,"
                    + "SUPPLIER.NAMA,PEMBELIAN.NOFAKTUR,PEMBELIAN.NOFAKTURSUPPLIER,"
                    + "case RETURBELI.STATUS "
                    + "when 0 then 'Draft' "
                    + "when 1 then 'Release' "
                    + "when 2 then 'Batal' end as STATUS "
                    + "FROM PEMBELIAN INNER JOIN RETURBELI ON PEMBELIAN.ID = RETURBELI.IDPEMBELIAN "
                    + "INNER JOIN SUPPLIER ON RETURBELI.IDSUPPLIER = SUPPLIER.IDSUPPLIER "
                    + "where month(RETURBELI.TANGGAL)='"+ (cboBulan.getSelectedIndex()+1) +"' and year(RETURBELI.TANGGAL)='"+txtTahun.getText()+"'";
            if (txtNofaktur.getText().equals("")) {
                sql += "";
            } else {
                sql += " and PEMBELIAN.NOFAKTUR LIKE '%" + txtNofaktur.getText() + "%'";
            }
