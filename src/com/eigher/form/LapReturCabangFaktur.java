 ...
 * @author erwadi
 */
public class LapReturCabangFaktur extends javax.swing.JInternalFrame {
com.erv.function.Util u = new com.erv.function.Util();
Connection c;
    /** Creates new form LaporanKartuStok */
    public LapReturCabangFaktur() {
        initComponents();
        try {
            c = koneksi.getKoneksiJ();
            txtTahun.setText(u.thnsekarang+"");
        } catch (SQLException ex) {
            Logger.getLogger(LapReturCabangFaktur.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(LapReturCabangFaktur.class);
    ...
    void reloadData() {
        try {
            ...
            String sql = "SELECT RETUR.KODERETUR,RETUR.TANGGAL,"
                    ...
                    + "where month(RETUR.TANGGAL)='"+ (cboBulan.getSelectedIndex()+1) +"' and year(RETUR.TANGGAL)='"+txtTahun.getText()+"' AND PELANGGAN.STATUSCABANG='1'";
