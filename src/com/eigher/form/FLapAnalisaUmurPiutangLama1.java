 ...
 * @author eigher
 */
public class FLapAnalisaUmurPiutangLama1 extends javax.swing.JInternalFrame {
     ...
     */
    public FLapAnalisaUmurPiutangLama1() {
        initComponents();
        try {
            ...
            Logger.getLogger(FLapAnalisaUmurPiutangLama1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapAnalisaUmurPiutangLama1.class);
        ...
        jScrollPane1.setBounds(160, 70, 350, 120);
        ...
        btnKeluar.setBounds(220, 160, 150, 40);
        ...
        btnPreview.setBounds(50, 160, 140, 40);
        ...
        pilihan.setBounds(310, 110, 140, 25);
        ...
        cboStatusPiutang.setBounds(140, 110, 140, 21);

        setBounds(0, 0, 533, 242);
...
//                    URL url = new URL(global.REPORT + "/RekapAnalisaPiutangAllPelanggan.jasper");
                    URL url = new URL(global.REPORT + "/LapAnalisaPiutangAllPelanggan.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                } else if (cboStatusPiutang.getSelectedIndex() == 1) {
                    URL url = new URL(global.REPORT + "/LapAnalisaPiutangAllPelangganLunas.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                } else if (cboStatusPiutang.getSelectedIndex() == 2) {
                    URL url = new URL(global.REPORT + "/LapAnalisaPiutangAllPelangganBelumLunas.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                }
            } else {
                if (cboStatusPiutang.getSelectedIndex() == 0) {
                    ...
                    URL url = new URL(global.REPORT + "/LapAnalisaPiutangLunas.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                } else if (cboStatusPiutang.getSelectedIndex() == 2) {
                    URL url = new URL(global.REPORT + "/LapAnalisaPiutangBelumLunas.jasper");
                    InputStream in = url.openStream();
                    jasperPrint = JasperFillManager.fillReport(in, parameter, c);
                }
