 ...
 * @author eigher
 */
public class FRekapReturCabang extends javax.swing.JInternalFrame {
    ...
    public FRekapReturCabang() {
        ...
        try {
            ...
            Logger.getLogger(FRekapReturCabang.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FRekapReturCabang.class);
    ...
    private void btnPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreviewActionPerformed
        ...
        try {
            ...
            URL url = new URL(global.REPORT + "/RekapReturCabangHarian.jasper");
