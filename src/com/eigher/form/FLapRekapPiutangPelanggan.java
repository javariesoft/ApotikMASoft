 ...
 * @author eigher
 */
public class FLapRekapPiutangPelanggan extends javax.swing.JInternalFrame {
     ...
     */
    public FLapRekapPiutangPelanggan() {
        initComponents();
        try {
            c = koneksi.getKoneksiJ();
        } catch (SQLException ex) {
            Logger.getLogger(FLapRekapPiutangPelanggan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapRekapPiutangPelanggan.class);
