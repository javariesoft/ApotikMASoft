 ...
 * @author eigher
 */
public class FLapTutupBuku extends javax.swing.JInternalFrame {
     ...
     */
    public FLapTutupBuku() {
        initComponents();
        txttahun.setText(u.thnsekarang + "");
        try {
            c = koneksi.getKoneksiJ();
        } catch (Exception ex) {
            Logger.getLogger(FLapTutupBuku.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(javariesoft.JavarieSoftApp.class).getContext().getResourceMap(FLapTutupBuku.class);
        ...
        jButton2.setBounds(180, 80, 120, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            //jasperPrint = JasperFillManager.fillReport("report\\LapTutupBuku.jasper", parameter, koneksi.getKoneksiJ());
            URL url = new URL(global.REPORT + "/LapTutupBuku.jasper");
